...
window.NetrunnerDB = {
    ...
    BUILDER_FIELDS: ['Resolve', 'Enumerate', 'abilities', 'subroutines', 'canUseCredits', 'canHost', 'installOnlyOn', 'modifyStrength', 'modifyInstallCost', 'modifyAdvancementRequirement', 'modifyBreachAccess', 'automaticOnInstall', 'automaticOnAccess', 'automaticOnEncounter', 'automaticOnAnyChange', 'responseOnRunSuccessful', 'responseOnRunEnds', 'responseOnEncounterEnds', 'responseOnRunnerTurnBegins', 'responseOnCorpTurnBegins', 'responseOnScored', 'responseOnStolen', 'responsePreventableAddTags', 'responsePreventableDamage', 'responsePreventableExpose', 'responsePreventableTrash'],
        ...
        for (const key in card) {
            ...
            if (this.BUILDER_FIELDS.includes(key)) {
                ...
                buildBtn.onclick = () => {
                    ...
                    if (this.openBlockBuilder) {
                        this.openBlockBuilder();
                    }
                };
